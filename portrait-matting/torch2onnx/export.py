...
by command-line options (default to 448x256).

Example usage: (Recommended to run this inside a virtual environment)
$ python export.py --width 448 --height 256 \
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--width', type=int, default=448,
        help='image width of the converted ONNX model [448]')
    parser.add_argument(
        '--height', type=int, default=256,
        help='image width of the converted ONNX model [256]')
    parser.add_argument(
